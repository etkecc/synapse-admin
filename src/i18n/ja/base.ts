...
const japaneseMessages: TranslationMessages = {
  ra: {
    ...
    message: {
      ...
      authentication_error: "認証サーバーでエラーが発生し、このページを表示する権限があるか確認できませんでした",
      ...
      delete_title: "%{name} %{recordRepresentation} を削除",
      details: "詳細",
      ...
      placeholder_data_warning: "通信エラーのため、データの再取得に失敗しました",
      select_all_limit_reached: "選択できる項目が上限に達しました。最初の%{max}件が選択されています",
    ...
    sort: {
      sort_by: "%{field_lower_first}を%{order}で並び替える",
      ASC: "昇順",
      DESC: "降順",
    },
    auth: {
