...
const common = {
  ...
  etkecc: {
    ...
    billing: {
      ...
      description2: "To change your billing email or add company details to invoices:",
      invoice_emails: {
        title: "Invoice emails",
        enabled_label: "Email invoices to specific addresses",
        emails_label: "Recipient addresses",
        emails_placeholder: "billing@example.com",
        emails_helper: "Press Enter to add each address. Up to 5.",
        description: "New settings apply to future invoices only; past invoices are not resent.",
        save: "Save",
        confirm_title: "Save invoice email settings?",
        confirm_additive: "Apply these recipients to future invoices?",
        confirm_destructive:
          "This removes %{emails} and cancels any pending invoice emails for this server. Recipients are not remembered after removal. Continue?",
        saved: "Invoice email settings saved.",
        saved_canceled:
          "Settings saved. %{smart_count} pending invoice email was canceled. |||| Settings saved. %{smart_count} pending invoice emails were canceled.",
        saved_canceled_retry:
          "Settings saved. If an earlier attempt went through, some pending invoice emails may already have been canceled.",
        error_rate_limited: "Too many changes in a short time. Please wait a moment and try again.",
        error_save: "Could not save invoice email settings. Please try again.",
        error_load: "Could not load invoice email settings. Please try again later.",
        invalid_email: "Enter a valid email address.",
        too_many: "Add at most %{smart_count} address. |||| Add at most %{smart_count} addresses.",
      },
      company_details: {
        open: "Add company details",
        title: "Add company details to invoices",
        description: "Enter your company details below to add them to your future invoices.",
        fields: {
          vat_id: "VAT/Tax ID",
        ...
        success:
          "Your request has been sent. We will add these details to all future invoices; past invoices are not changed.",
