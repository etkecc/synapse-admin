...
const common: Record<string, any> = {
  ...
  etkecc: {
    ...
    billing: {
      ...
      description1:
        "Тут ви можете переглядати платежі та формувати рахунки. Докладніше про керування підпискою можна знайти на",
    ...
    status: {
      ...
      intro1: "Це звіт моніторингу вашого сервера в реальному часі. Докладніше можна знайти на",
