const users = {
  ...
  helper: {
    ...
    mas_synapse_sort:
      "MAS не підтримує нативне сортування. Результати завантажуються з Synapse — деякі фільтри в цьому режимі недоступні.",
    mas_synapse_sort_reset: "Прибрати сортування",
  },
  action: {
