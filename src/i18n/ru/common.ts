...
const common: Record<string, any> = {
  ...
  etkecc: {
    ...
    billing: {
      ...
      description1:
        "Здесь вы можете просматривать платежи и формировать счета. Подробнее об управлении подпиской можно узнать на",
    ...
    status: {
      ...
      intro1: "Это отчёт мониторинга вашего сервера в реальном времени. Подробнее можно узнать на",
