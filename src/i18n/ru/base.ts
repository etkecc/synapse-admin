...
const russianMessages: TranslationMessages = {
  ra: {
    action: {
      ...
      add: "Добавить",
      back: "Назад",
      bulk_actions: "1 выбран |||| %{smart_count} выбраны |||| %{smart_count} выбраны",
      cancel: "Отмена",
    ...
    sort: {
      sort_by: "Сортировать по %{field_lower_first} в порядке %{order}",
      ASC: "возрастания",
      DESC: "убывания",
    },
    auth: {
    ...
    notification: {
      updated: "Элемент обновлён |||| %{smart_count} элемента обновлено |||| %{smart_count} элементов обновлено",
      created: "Элемент создан",
      deleted: "Элемент удалён |||| %{smart_count} элемента удалено |||| %{smart_count} элементов удалено",
