const users = {
  ...
  helper: {
    ...
    mas_synapse_sort:
      "MAS не поддерживает нативную сортировку. Результаты загружаются из Synapse — некоторые фильтры в этом режиме недоступны.",
    mas_synapse_sort_reset: "Убрать сортировку",
  },
  badge: {
    you: "Вы",
    bot: "Бот",
