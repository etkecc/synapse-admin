...
const farsiMessages: TranslationMessages = {
  ra: {
    ...
    message: {
      ...
      bulk_update_title: "بروز‌رسانی %{name} %{recordRepresentation} |||| بروز‌رسانی %{smart_count} %{name}",
    ...
    navigation: {
      ...
      no_results: "نتیجه‌ای برای %{name} پیدا نشد",
      ...
      partial_page_range_info: "%{offsetBegin}-%{offsetEnd} بیشتر از %{offsetEnd}",
    ...
    notification: {
      updated: "المان بروز‌رسانی شد |||| %{smart_count} المان بروز‌رسانی شد",
      created: "المان ایجاد شد",
      deleted: "المان حذف شد |||| %{smart_count} المان حذف شد",
