...
const germanMessages: TranslationMessages = {
  ra: {
    ...
    message: {
      ...
      bulk_update_content:
        "Sicher, dass Sie %{name} %{recordRepresentation} aktualisieren wollen? |||| Sicher, dass Sie %{smart_count} Elemente aktualisieren wollen?",
      bulk_update_title: "%{name} %{recordRepresentation} aktualisieren |||| %{smart_count} %{name} aktualisieren",
