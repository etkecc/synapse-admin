  ...
  import_users: {
    ...
    cards: {
      ...
      upload: {
        ...
        explanation: "Here you can upload a file with comma separated values that is processed to create or update users. The file must include the fields 'id' and 'displayname'. You can download and adapt an example file here: "
      },
      startImport: {
  ...
  resources: {
    ...
    room_directory: {
      ...
      action: {
        ...
        content: "Are you sure you want to remove this room from directory? |||| Are you sure you want to remove these %{smart_count} rooms from directory?",
    ...
    registration_tokens: {
      ...
      helper: {
        length: "Length of the token if no token is given."
      }
    }
  },
  scheduled_commands: {
